...
window['ThemeComponent_Photoswipe'] = () => {
  return {
    sectionContainer: null,
    parent: null,

    mounted() {
      this.sectionContainer = this.$el.closest('.shopify-section');
      this.parent = this.$el.parentElement;
      const imageDataEl = this.$el.querySelector('[data-photoswipe-images]');
      ...
      this.parent.addEventListener('shapes:photoswipe:open', e => {
        options.index = e.detail.index; // defines start slide index
